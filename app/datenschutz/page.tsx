      ...
      <main className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700">
              Beim Aufruf dieser Website werden automatisch allgemeine
              Informationen erfasst (z. B. Browsertyp, Zugriffszeit, IP-Adresse
              in anonymisierter Form). Diese Daten dienen ausschließlich der
              technischen Sicherheit und werden nicht mit anderen Daten
              verknüpft.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="text-gray-700 mt-2 space-y-1 list-disc list-inside">
              <li>
                speichern wir ausschließlich für die Dauer der Terminabwicklung
              </li>
              <li>löschen wir spätestens 6 Monate nach dem Termin</li>
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              gesetzlichen Aufbewahrungsfristen bestehen. <br /> <br /> <br />{" "}
              Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
              Datenschutz hat einen besonders hohen Stellenwert für die
              Geschäftsleitung des Longvity Center. Eine Nutzung der
              Internetseiten der Longvity Center ist grundsätzlich ohne jede
              ...
              Longvity Center geltenden landesspezifischen
              ...
              zustehenden Rechte aufgeklärt. Die Longvity Center hat als für die
              ...
              übermitteln. 1. Begriffsbestimmungen Die Datenschutzerklärung der
              Longvity Center beruht auf den Begrifflichkeiten, die durch den
              ...
              verwendeten Begrifflichkeiten erläutern. Wir verwenden in dieser
              ...
              sind, identifiziert werden kann. b) betroffene Person Betroffene
              ...
              Verantwortlichen verarbeitet werden. c) Verarbeitung Verarbeitung
              ...
              Einschränkung, das Löschen oder die Vernichtung. d) Einschränkung
              ...
              Verarbeitung einzuschränken. e) Profiling Profiling ist jede Art
              der automatisierten Verarbeitung personenbezogener Daten, die
              darin besteht, dass diese personenbezogenen Daten verwendet
              werden, um bestimmte persönliche Aspekte, die sich auf eine
              natürliche Person beziehen, zu bewerten, insbesondere, um Aspekte
              ...
              analysieren oder vorherzusagen. f) Pseudonymisierung
              ...
              zugewiesen werden. g) Verantwortlicher oder für die Verarbeitung
              Verantwortlicher Verantwortlicher oder für die Verarbeitung
              ...
              werden. h) Auftragsverarbeiter Auftragsverarbeiter ist eine
              natürliche oder juristische Person, Behörde, Einrichtung oder
              andere Stelle, die personenbezogene Daten im Auftrag des
              Verantwortlichen verarbeitet. i) Empfänger Empfänger ist eine
              natürliche oder juristische Person, Behörde, Einrichtung oder
              ...
              gelten jedoch nicht als Empfänger. j) Dritter Dritter ist eine
              natürliche oder juristische Person, Behörde, Einrichtung oder
              ...
              verarbeiten. k) Einwilligung Einwilligung ist jede von der
              ...
              betreffenden personenbezogenen Daten einverstanden ist. 2. Name
              ...
              datenschutzrechtlichem Charakter ist die: Longvity Center
              Geiserichstraße 3 12105 Berlin Deutschland Tel.: 0049-30-7537100
              E-Mail: info@longvitycenter.com Website: www.longvitycenter.de 3.
              Cookies Die Internetseiten der Longvity Center verwenden Cookies.
              ...
              den Einsatz von Cookies kann die Longvity Center den Nutzern
              dieser Internetseite nutzerfreundlichere Services bereitstellen,
              die ohne die Cookie-Setzung nicht möglich wären. Mittels eines
              Cookies können die Informationen und Angebote auf unserer
              ...
              hat, über ein Cookie. Die betroffene Person kann die Setzung von
              ...
              widersprechen. Ferner können bereits gesetzte Cookies jederzeit
              ...
              Funktionen unserer Internetseite vollumfänglich nutzbar. 4.
              Erfassung von allgemeinen Daten und Informationen Die
              Internetseite der Longvity Center erfasst mit jedem Aufruf der
              ...
              Systeme dienen. Bei der Nutzung dieser allgemeinen Daten und
              Informationen zieht die Longvity Center keine Rückschlüsse auf die
              ...
              anonym erhobenen Daten und Informationen werden durch die Longvity
              Center daher einerseits statistisch und ferner mit dem Ziel
              ...
              personenbezogenen Daten gespeichert. 5. Routinemäßige Löschung und
              Sperrung von personenbezogenen Daten Der für die Verarbeitung
              ...
              des Speicherungszwecks erforderlich ist oder sofern dies durch den
              ...
              gesetzlichen Vorschriften gesperrt oder gelöscht. 6. Rechte der
              betroffenen Person a) Recht auf Bestätigung Jede betroffene Person
              ...
              Verantwortlichen wenden. b) Recht auf Auskunft Jede von der
              ...
              jederzeit von dem für die Verarbeitung Verantwortlichen
              ...
              Informationen zugestanden: die Verarbeitungszwecke die Kategorien
              personenbezogener Daten, die verarbeitet werden die Empfänger oder
              ...
              der Fall ist, so steht der betroffenen Person im Übrigen das Recht
              ...
              wenden. c) Recht auf Berichtigung Jede von der Verarbeitung
              ...
              Verantwortlichen wenden. d) Recht auf Löschung (Recht auf
              ...
              zutrifft und soweit die Verarbeitung nicht erforderlich ist: Die
              ...
              gemäß Art. 21 Abs. 2 DS-GVO Widerspruch gegen die Verarbeitung
              ...
              bei der Longvity Center gespeichert sind, veranlassen möchte, kann
              sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Longvity
              Center wird veranlassen, dass dem Löschverlangen unverzüglich
              nachgekommen wird. Wurden die personenbezogenen Daten von der
              Longvity Center öffentlich gemacht und ist unser Unternehmen als
              Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
              personenbezogenen Daten verpflichtet, so trifft die Longvity
              Center unter Berücksichtigung der verfügbaren Technologie und der
              ...
              der Longvity Center wird im Einzelfall das Notwendige veranlassen.
              ...
              betroffene Person lehnt die Löschung der personenbezogenen Daten
              ab und verlangt stattdessen die Einschränkung der Nutzung der
              ...
              Einschränkung von personenbezogenen Daten, die bei der Longvity
              Center gespeichert sind, verlangen möchte, kann sie sich hierzu
              jederzeit an einen Mitarbeiter des für die Verarbeitung
              Verantwortlichen wenden. Der Mitarbeiter der Longvity Center wird
              die Einschränkung der Verarbeitung veranlassen. f) Recht auf
              Datenübertragbarkeit Jede von der Verarbeitung personenbezogener
              Daten betroffene Person hat das vom Europäischen Richtlinien- und
              ...
              einem Vertrag gemäß Art. 6 Abs. 1 Buchstabe b DS-GVO beruht und
              ...
              einen Mitarbeiter der Longvity Center wenden. g) Recht auf
              Widerspruch Jede von der Verarbeitung personenbezogener Daten
              ...
              Longvity Center verarbeitet die personenbezogenen Daten im Falle
              ...
              Ausübung oder Verteidigung von Rechtsansprüchen. Verarbeitet die
              Longvity Center personenbezogene Daten, um Direktwerbung zu
              ...
              steht. Widerspricht die betroffene Person gegenüber der Longvity
              Center der Verarbeitung für Zwecke der Direktwerbung, so wird die
              Longvity Center die personenbezogenen Daten nicht mehr für diese
              ...
              der Longvity Center zu wissenschaftlichen oder historischen
              ...
              Mitarbeiter der Longvity Center oder einen anderen Mitarbeiter
              ...
              bei denen technische Spezifikationen verwendet werden. h)
              ...
              Person, trifft die Longvity Center angemessene Maßnahmen, um die
              ...
              Verarbeitung Verantwortlichen wenden. i) Recht auf Widerruf einer
              datenschutzrechtlichen Einwilligung Jede von der Verarbeitung
              personenbezogener Daten betroffene Person hat das vom Europäischen
              Richtlinien- und Verordnungsgeber gewährte Recht, eine
              Einwilligung zur Verarbeitung personenbezogener Daten jederzeit zu
              widerrufen. Möchte die betroffene Person ihr Recht auf Widerruf
              einer Einwilligung geltend machen, kann sie sich hierzu jederzeit
              an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
              wenden. 7. Datenschutzbestimmungen zu Einsatz und Verwendung von
              Facebook Der für die Verarbeitung Verantwortliche hat auf dieser
              Internetseite Komponenten des Unternehmens Facebook integriert.
              Facebook ist ein soziales Netzwerk. Ein soziales Netzwerk ist ein
              ...
              Freundschaftsanfragen. Betreibergesellschaft von Facebook ist die
              ...
              Dublin 2, Ireland. Durch jeden Aufruf einer der Einzelseiten
              ...
              betroffene Person gleichzeitig bei Facebook eingeloggt ist,
              ...
              speichert diese personenbezogenen Daten. Facebook erhält über die
              ...
              Informationen an Facebook von der betroffenen Person nicht
              gewollt, kann diese die Übermittlung dadurch verhindern, dass sie
              sich vor einem Aufruf unserer Internetseite aus ihrem
              Facebook-Account ausloggt. Die von Facebook veröffentlichte
              ...
              um eine Datenübermittlung an Facebook zu unterdrücken. 8.
              Datenschutzbestimmungen zu Einsatz und Verwendung von Google
              Analytics (mit Anonymisierungsfunktion) Der für die Verarbeitung
              Verantwortliche hat auf dieser Internetseite die Komponente Google
              Analytics (mit Anonymisierungsfunktion) integriert. Google
              Analytics ist ein Web-Analyse-Dienst. Web-Analyse ist die
              ...
              Person auf eine Internetseite gekommen ist (sogenannte Referrer),
              ...
              dargestellt, jederzeit mittels einer entsprechenden Einstellung
              des genutzten Internetbrowsers verhindern und damit der Setzung
              von Cookies dauerhaft widersprechen. Eine solche Einstellung des
              ...
              Aktivierung des Browser-Add-Ons. Weitere Informationen und die
              ...
              https://www.google.com/intl/de_de/analytics/ genauer erläutert. 9.
              Datenschutzbestimmungen zu Einsatz und Verwendung von YouTube Der
              ...
              Person zugeordnet. YouTube und Google erhalten über die
              YouTube-Komponente immer dann eine Information darüber, dass die
              betroffene Person unsere Internetseite besucht hat, wenn die
              betroffene Person zum Zeitpunkt des Aufrufs unserer Internetseite
              gleichzeitig bei YouTube eingeloggt ist; dies findet unabhängig
              davon statt, ob die betroffene Person ein YouTube-Video anklickt
              oder nicht. Ist eine derartige Übermittlung dieser Informationen
              an YouTube und Google von der betroffenen Person nicht gewollt,
              kann diese die Übermittlung dadurch verhindern, dass sie sich vor
              einem Aufruf unserer Internetseite aus ihrem YouTube-Account
              ausloggt. Die von YouTube veröffentlichten
              ...
              personenbezogener Daten durch YouTube und Google. 10.
              Rechtsgrundlage der Verarbeitung Art. 6 I lit. a DS-GVO dient
              unserem Unternehmen als Rechtsgrundlage für Verarbeitungsvorgänge,
              bei denen wir eine Einwilligung für einen bestimmten
              ...
              (Erwägungsgrund 47 Satz 2 DS-GVO). 11. Berechtigte Interessen an
              der Verarbeitung, die von dem Verantwortlichen oder einem Dritten
              verfolgt werden Basiert die Verarbeitung personenbezogener Daten
              auf Artikel 6 I lit. f DS-GVO ist unser berechtigtes Interesse die
              Durchführung unserer Geschäftstätigkeit zugunsten des Wohlergehens
              all unserer Mitarbeiter und unserer Anteilseigner. 12. Dauer, für
              die die personenbezogenen Daten gespeichert werden Das Kriterium
              für die Dauer der Speicherung von personenbezogenen Daten ist die
              jeweilige gesetzliche Aufbewahrungsfrist. Nach Ablauf der Frist
              ...
              zur Bereitstellung der personenbezogenen Daten; Erforderlichkeit
              für den Vertragsabschluss; Verpflichtung der betroffenen Person,
              die personenbezogenen Daten bereitzustellen; mögliche Folgen der
              ...
              Nichtbereitstellung der personenbezogenen Daten hätte. 14.
              Bestehen einer automatisierten Entscheidungsfindung Als
              verantwortungsbewusstes Unternehmen verzichten wir auf eine
              automatische Entscheidungsfindung oder ein Profiling. Diese
              Datenschutzerklärung wurde durch den
              Datenschutzerklärungs-Generator von den externer DSB Duisburg in
              Kooperation mit der RC GmbH, die gebrauchte Notebooks
              wiederverwertet und den Datenschutz Anwälten der Kanzlei WILDE
              BEUGER SOLMECKE | Rechtsanwälte erstellt.
            </p>
          </section>
        </div>
